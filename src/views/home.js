...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Gourmet cafe</title>
        <meta property="og:title" content="Gourmet cafe" />
      </Helmet>
      <div className="home-header">
        <header data-thq="thq-navbar" className="home-navbar-interactive">
          <span className="home-logo">CAFÉ GOURMET</span>
          <div data-thq="thq-navbar-nav" className="home-desktop-menu">
            <nav className="home-links">
              <Link to="/registro">Registro de Usuário</Link>
              <Link to="/cardapio" className="home-nav2">
                Catálogo de Produtos
              </Link>
              <span className="home-nav3">Pedidos Online</span>
              <span className="home-nav4">Personalização de Pedidos</span>
              <Link to="/pagamento" className="home-nav5">
                Pagamentos 
              </Link>
            </nav>
            <div className="home-buttons">
              <Link to="/registro" className="home-login button">
                Login
              </Link>
              <Link to="/registro" className="home-register button">
                Register
              </Link>
            </div>
          </div>
          ...
          <div data-thq="thq-mobile-menu" className="home-mobile-menu">
            <div className="home-nav">
              <div className="home-top">
                <span className="home-logo1">CAFÉ GOURMET</span>
              ...
              <nav className="home-links1">
                <span className="home-nav11">Registro de Usuário</span>
                <span className="home-nav21">Catálogo de Produtos</span>
                <span className="home-nav31">Pedidos Online</span>
                <span className="home-nav41">Personalização de Pedidos</span>
                <span className="home-nav51">Pagamentos Seguros</span>
              </nav>
        ...
        <div className="home-hero1">
          <div className="home-container01">
            <h1 className="home-hero-heading heading1">
              Bem-vindo ao aplicativo de Cafeteria Gourmet
            </h1>
            <span className="home-hero-sub-heading">
              Desfrute de uma experiência única de café
            </span>
            <div className="home-btn-group">
              <Link to="/registro" className="home-hero-button1 button">
                Get Started
              </Link>
              <a href="#produtos" className="home-hero-button2 button">
                Learn More →
              </a>
            </div>
          </div>
      ...
      <div className="home-details">
        <div className="home-details1">
          ...
          <Link to="/cardapio" className="home-navlink">
            <img
              alt="image"
          ...
          <div className="home-features1">
            <div className="home-container03">
              ...
              <h2 className="home-features-heading heading2">
                Recursos do aplicativo de cafeteria gourmet
              </h2>
              <span className="home-features-sub-heading">
                Descubra as funcionalidades que tornam o nosso aplicativo único
                e conveniente para os amantes de café gourmet.
              </span>
            </div>
            <div className="home-container04">
              <Link to="/registro">
                <FeatureCard
                  Heading="Registro de usuário"
                  SubHeading="Os clientes podem criar uma conta com informações pessoais básicas para se registrar no aplicativo."
                  className="home-feature-card1"
                ></FeatureCard>
              </Link>
              <Link to="/cardapio">
                <FeatureCard
                  Heading="Catálogo de produtos"
                  SubHeading="Apresenta um catálogo detalhado dos produtos oferecidos pela cafeteria gourmet, incluindo descrição, preço e imagem."
              ...
              <Link to="/pagamento">
                <FeatureCard
                  ...
                  SubHeading="Os clientes podem fazer pedidos diretamente pelo aplicativo, adicionando produtos ao carrinho, personalizando itens e visualizando o total do pedido."
                  className="home-feature-card3"
                ></FeatureCard>
              </Link>
              <Link to="/cardapio">
                <FeatureCard
                  Heading="Personalização de pedidos"
                  SubHeading="Os clientes podem personalizar seus pedidos de acordo com suas preferências, escolhendo o tipo de grão de café, intensidade, temperatura, tamanho da xícara, quantidade de açúcar, entre outros."
        ...
        <div className="home-pricing1">
          <div className="home-container05">
            ...
            <span className="home-pricing-sub-heading">
              Oferecemos diferentes opções para atender às suas preferências e
              orçamento
            </span>
          </div>
            ...
            <div className="home-pricing-card">
              <div className="home-container07">
                ...
                <span className="home-free-plan-description">
                  Acesso básico ao aplicativo de cafeteria gourmet
                </span>
              </div>
            ...
            <div className="home-pricing-card1">
              <div className="home-container14">
                ...
                <span className="home-basic-plan-description">
                  Recursos adicionais para uma experiência aprimorada
                </span>
              </div>
            ...
            <div className="home-pricing-card2">
              <div className="home-container22">
                ...
                <span className="home-pro-plan-description">
                  Acesso completo a todos os recursos do aplicativo
                </span>
              </div>
      ...
      <div className="home-gallery">
        <div className="home-gallery1">
          <h1 id="produtos" className="home-gallery-heading heading2">
            Produtos Gourmet
          </h1>
      ...
      <div className="home-footer">
        <footer className="home-footer1">
          <div className="home-container32">
            <span className="home-logo2">CAFÉ GOURMET</span>
            <nav className="home-nav1 home-nav1">
              <span className="home-nav12">Registro de Usuário</span>
              <span className="home-nav22">Catálogo de Produtos</span>
              <span className="home-nav32">Pedidos Online</span>
              <span className="home-nav42">Personalização de Pedidos</span>
              <span className="home-nav52">Pagamentos Seguros</span>
            </nav>
          </div>
